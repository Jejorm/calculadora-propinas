...
export default function OrderTotals({ order, tip, placeOrder }: OrderTotalsProps) {
  ...
  return (
    <>
      ...
      <button className="w-full bg-black p-3 uppercase text-white font-bold mt-10 cursor-pointer disabled:opacity-10 disabled:cursor-not-allowed" disabled={totalAmount === 0} onClick={placeOrder}>Guardar Orden</button>
    </>
  )
}
